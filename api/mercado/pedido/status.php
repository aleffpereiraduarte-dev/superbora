...
try {
    ...
    response(true, [
        ...
        "shopper" => $pedido["shopper_id"] ? [
            ...
            "latitude" => in_array($pedido["status"], ['preparando', 'em_preparo', 'coletando', 'em_coleta', 'pronto', 'em_entrega']) ? $pedido["shopper_lat"] : null,
            "longitude" => in_array($pedido["status"], ['preparando', 'em_preparo', 'coletando', 'em_coleta', 'pronto', 'em_entrega']) ? $pedido["shopper_lng"] : null,
        ] : null,
        "driver" => $driver,
