<?php
/**
 * Página de Erro 500 - OneMundo Mercado
 */
...
<head>
    ...
    <title>Erro Interno - OneMundo</title>
    <style>
...
<body>
    <div class="error-container">
        ...
        <h1>Erro Interno</h1>
        <p>Ocorreu um problema temporário em nossos servidores. Nossa equipe foi notificada e está trabalhando para resolver.</p>
        <a href="/mercado/" class="btn">Voltar ao Mercado</a>
    </div>
