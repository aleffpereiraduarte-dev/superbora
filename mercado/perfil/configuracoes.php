...
$pdo = new PDO("mysql:host=".(defined("DB_HOSTNAME")?DB_HOSTNAME:"localhost").";dbname=".(defined("DB_DATABASE")?DB_DATABASE:"default_db").";charset=utf8mb4", defined("DB_USERNAME")?DB_USERNAME:"default_user", defined("DB_PASSWORD")?DB_PASSWORD:"", [PDO::ATTR_ERRMODE=>PDO::ERRMODE_EXCEPTION, PDO::ATTR_DEFAULT_FETCH_MODE=>PDO::FETCH_ASSOC]);
...
header('Content-Security-Policy: default-src \'self\'; font-src \'self\' https://fonts.googleapis.com https://fonts.gstatic.com; style-src \'self\' \'unsafe-inline\' https://fonts.googleapis.com');
?><!DOCTYPE html>
<html lang="pt-BR">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>Configurações - Mercado OneMundo</title>
<link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
<link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&display=swap" rel="stylesheet">
<link rel="stylesheet" href="/mercado/assets/css/configuracoes.css?v=1.0">
...
<body>
<header class="header"><div class="header-inner"><a href="/mercado/perfil/" class="back-btn">← Voltar</a><h1 class="page-title">⚙️ Configurações</h1></div></header>
<main class="main">
<div class="card">
    <h3 class="card-title">👤 Meus Dados</h3>
    <div style="display:grid;gap:12px">
        <div><div style="font-size:12px;color:var(--gray-500);margin-bottom:4px">Nome</div><div style="font-weight:600"><?= htmlspecialchars(($customer["firstname"] ?? '') . " " . ($customer["lastname"] ?? '')) ?></div></div>
        <div><div style="font-size:12px;color:var(--gray-500);margin-bottom:4px">E-mail</div><div style="font-weight:600"><?= htmlspecialchars($customer["email"] ?? 'Não informado') ?></div></div>
        <div><div style="font-size:12px;color:var(--gray-500);margin-bottom:4px">Telefone</div><div style="font-weight:600"><?= htmlspecialchars($customer["telephone"] ?? 'Não informado') ?></div></div>
    </div>
    <a href="/index.php?route=account/edit" class="btn btn-outline" style="margin-top:16px">✏️ Editar Dados</a>
</div>
<div class="card">
    <h3 class="card-title">📍 Endereços</h3>
    <a href="/index.php?route=account/address" class="btn btn-outline">Gerenciar Endereços</a>
</div>
<div class="card">
    <h3 class="card-title">🔒 Segurança</h3>
    <a href="/index.php?route=account/password" class="btn btn-outline">Alterar Senha</a>
</div>
<div class="card">
    <h3 class="card-title">🚪 Sair</h3>
    <form method="POST" action="/mercado/perfil/logout.php" style="display:inline">
    <input type="hidden" name="csrf_token" value="<?= htmlspecialchars($_SESSION['csrf_token']) ?>">
    <button type="submit" class="btn btn-outline" style="color:#ef4444;border-color:#ef4444;background:none">Sair da Conta</button>
</form>
</div>
</main>
