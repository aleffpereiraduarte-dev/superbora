...
<body>
    ...
    <main class="main">
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:20px">
            <div class="card" style="cursor:pointer" onclick="alert('Em desenvolvimento')">
                <h3 class="card-title"><i class="fas fa-file-invoice-dollar"></i> Contas a Pagar</h3>
                <p style="color:var(--text2)">Relatório detalhado de despesas por período, fornecedor ou categoria.</p>
            </div>
            <div class="card" style="cursor:pointer" onclick="alert('Em desenvolvimento')">
                <h3 class="card-title"><i class="fas fa-hand-holding-usd"></i> Contas a Receber</h3>
                <p style="color:var(--text2)">Relatório de receitas previstas e recebidas.</p>
            </div>
            <div class="card" style="cursor:pointer" onclick="alert('Em desenvolvimento')">
                <h3 class="card-title"><i class="fas fa-chart-line"></i> Fluxo de Caixa</h3>
                <p style="color:var(--text2)">Projeção de entradas e saídas futuras.</p>
            </div>
            <div class="card" style="cursor:pointer" onclick="alert('Em desenvolvimento')">
                <h3 class="card-title"><i class="fas fa-balance-scale"></i> DRE</h3>
                <p style="color:var(--text2)">Demonstrativo de Resultado do Exercício.</p>
            </div>
            <div class="card" style="cursor:pointer" onclick="alert('Em desenvolvimento')">
                <h3 class="card-title"><i class="fas fa-sitemap"></i> Por Centro de Custo</h3>
                <p style="color:var(--text2)">Despesas agrupadas por centro de custo.</p>
            </div>
            <div class="card" style="cursor:pointer" onclick="alert('Em desenvolvimento')">
                <h3 class="card-title"><i class="fas fa-truck"></i> Por Fornecedor</h3>
                <p style="color:var(--text2)">Ranking de fornecedores por volume de pagamentos.</p>
            </div>
        </div>
