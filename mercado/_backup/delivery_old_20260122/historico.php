...
<body>
    ...
    async function loadHistory() {
        ...
        container.innerHTML = "<div class='empty'><i class='fas fa-spinner fa-spin' style='font-size:2rem;margin-bottom:10px'></i><p>Carregando...</p></div>";
        try {
            ...
            container.innerHTML = "<div class='empty'><i class='fas fa-exclamation-triangle' style='font-size:2rem;margin-bottom:10px'></i><p>Erro ao carregar histórico</p><button onclick='loadHistory()' style='margin-top:10px;padding:8px 16px;border:none;background:#3b82f6;color:white;border-radius:6px'>Tentar Novamente</button></div>"; 
        }
    }
    loadHistory();
    </script>
