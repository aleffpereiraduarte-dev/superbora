...
if (!is_numeric($delivery_id) || $delivery_id <= 0) {
    session_destroy();
...
<html lang="pt-BR">
<?php
header("Content-Security-Policy: default-src 'self'; style-src 'self' 'unsafe-inline' fonts.googleapis.com cdnjs.cloudflare.com; font-src fonts.gstatic.com cdnjs.cloudflare.com; script-src 'self' 'unsafe-inline';");
...
<body>
    ...
    <div class="stats">
        <div class="stat"><div class="stat-value" id="deliveries">...</div><div class="stat-label">Entregas</div></div>
        <div class="stat"><div class="stat-value" id="km">...</div><div class="stat-label">Km</div></div>
        <div class="stat"><div class="stat-value" id="rating">...</div><div class="stat-label">Nota</div></div>
    </div>
    <div class="section">
    ...
    async function loadEarnings() {
        try {
            ...
            document.getElementById("earnings-list").innerHTML = "<p style='text-align:center;color:#ef4444'>Erro ao carregar dados</p>";
        }
    }
    loadEarnings();
    </script>
