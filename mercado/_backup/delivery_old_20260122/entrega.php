<?php
/**
 * 🚴 ONEMUNDO DELIVERY - TELA DE ENTREGA
 */
require_once 'config.php';
requireLogin();

$delivery = getDelivery();
$order_id = filter_var($_GET['order'] ?? 0, FILTER_VALIDATE_INT);
if (!$order_id) {
...
// Iniciar entrega se ainda não iniciou
...
<body>
    ...
    <div class="content">
        <div class="status-steps">
            <div class="step done"><div class="step-icon">✓</div><span class="step-label">Aceito</span></div>
            <div class="step <?= $order['status'] === 'em_entrega' ? 'active' : 'done' ?>"><div class="step-icon">🚴</div><span class="step-label">A caminho</span></div>
            <div class="step"><div class="step-icon">📍</div><span class="step-label">Chegou</span></div>
            <div class="step"><div class="step-icon">✅</div><span class="step-label">Entregue</span></div>
        </div>
        ...
        <div class="info-card">
            ...
            <p class="address" style="margin-top:8px;color:#f59e0b;">🚪 <?= htmlspecialchars($order['delivery_complement']) ?></p>
            <?php endif; ?>
            <?php if ($order['delivery_reference']): ?>
            <p class="address" style="margin-top:8px;color:#94a3b8;">📝 <?= htmlspecialchars($order['delivery_reference']) ?></p>
            <?php endif; ?>
        </div>
        ...
        <div class="info-card">
            ...
            <div class="customer-row">
                ...
                <a href="tel:<?= $order['customer_phone'] ?>" class="btn-call">📞</a>
                <a href="https://wa.me/55<?= preg_replace('/\D/', '', $order['customer_phone']) ?>" class="btn-whatsapp" target="_blank" rel="noopener noreferrer">💬</a>
            </div>
        </div>
        ...
        <div class="delivery-code-section">
            ...
            <p>Peça este código ao cliente para confirmar</p>
        </div>
    </div>
    
    <div class="bottom-actions">
        <button class="btn-navigate" onclick="openNavigation()">🗺️ Abrir no Maps</button>
        <button class="btn-confirm" onclick="openConfirmModal()">✅ Confirmar Entrega</button>
    </div>
    ...
    <div class="modal" id="confirmModal">
        <div class="modal-content">
            ...
            <p>Peça o código de entrega ao cliente</p>
    ...
    <div class="modal" id="successModal">
        <div class="modal-content success-modal">
            ...
            <p>Parabéns pela entrega!</p>
            <div class="earning">+R$ 8,00</div>
            <button class="btn-verify" onclick="window.location.href='index.php'" style="width:100%;">Voltar ao Início</button>
        </div>
    </div>
    ...
    <script>
        ...
        // Mapa simples com imagem estática
...
.then(r => r.json())
.then(data => {
    document.getElementById('map').innerHTML = `<img src="${data.map_url}" style="width:100%;height:100%;object-fit:cover;" onerror="this.src='https://via.placeholder.com/600x300/334155/94a3b8?text=Mapa'">`;
});
