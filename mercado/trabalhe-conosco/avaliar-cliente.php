...
/**
 * ╔══════════════════════════════════════════════════════════════════════════════════════╗
 * ║                         <svg fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"/></svg> AVALIAR CLIENTE - PÓS ENTREGA                             ║
 * ║                    Worker avalia experiência com o cliente                           ║
 * ╚══════════════════════════════════════════════════════════════════════════════════════╝
 */
...
$tags_positivas = [
    ['id' => 'educado', 'emoji' => '😊', 'text' => 'Educado(a)'],
    ['id' => 'gorjeta', 'emoji' => '<svg fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>', 'text' => 'Deu gorjeta'],
    ['id' => 'pontual', 'emoji' => '⏰', 'text' => 'Estava esperando'],
    ['id' => 'facil', 'emoji' => '<svg fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/></svg>', 'text' => 'Fácil de encontrar'],
    ['id' => 'comunicativo', 'emoji' => '<svg fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"/></svg>', 'text' => 'Boa comunicação'],
];

$tags_negativas = [
    ['id' => 'demorou', 'emoji' => '<svg fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>', 'text' => 'Demorou para atender'],
    ['id' => 'dificil', 'emoji' => '🗺️', 'text' => 'Difícil localização'],
    ['id' => 'grosso', 'emoji' => '😤', 'text' => 'Foi grosseiro(a)'],
    ['id' => 'reclamou', 'emoji' => '😠', 'text' => 'Reclamou sem motivo'],
];
?>
<!DOCTYPE html>
<html lang="pt-BR">
...
<body>
    <main class="main">
        ...
        <div class="success-header">
            <div class="success-icon"><svg fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg></div>
            <h1>Entrega Concluída!</h1>
            <p>Pedido <?= $order_id ?> entregue com sucesso</p>
            <div class="earnings-badge">
                <svg fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg> <span>+R$ <?= number_format($ganho_pedido, 2, ',', '.') ?></span>
            </div>
        </div>

        <!-- Client Card -->
        <div class="client-card">
            <div class="client-avatar"><?= $cliente['avatar'] ?></div>
            <div class="client-name"><?= htmlspecialchars($cliente['nome']) ?></div>
            <div class="client-address"><svg fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/></svg> <?= htmlspecialchars($cliente['endereco']) ?></div>
        </div>

        <!-- Stars -->
        <div class="stars-section">
            <div class="stars-label">Como foi a experiência com este cliente?</div>
            <div class="stars-container">
                <span class="star" data-value="1" onclick="setRating(1)"><svg fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"/></svg></span>
                <span class="star" data-value="2" onclick="setRating(2)"><svg fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"/></svg></span>
                <span class="star" data-value="3" onclick="setRating(3)"><svg fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"/></svg></span>
                <span class="star" data-value="4" onclick="setRating(4)"><svg fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"/></svg></span>
                <span class="star" data-value="5" onclick="setRating(5)"><svg fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"/></svg></span>
            </div>
            <div class="rating-text" id="rating-text"></div>
        </div>

        <!-- Positive Tags -->
        <div class="tags-section" id="positive-tags">
            <div class="tags-title">😊 O que foi bom?</div>
            <div class="tags-container">
                <?php foreach ($tags_positivas as $t): ?>
                <span class="tag" data-id="<?= $t['id'] ?>" onclick="toggleTag(this)">
                    <?= $t['emoji'] ?> <?= $t['text'] ?>
                </span>
                <?php endforeach; ?>
            </div>
        ...
        <!-- Negative Tags -->
        <div class="tags-section" id="negative-tags" style="display: none;">
            <div class="tags-title">😕 O que pode melhorar?</div>
            <div class="tags-container">
                <?php foreach ($tags_negativas as $t): ?>
                <span class="tag negative" data-id="<?= $t['id'] ?>" onclick="toggleTag(this)">
                    <?= $t['emoji'] ?> <?= $t['text'] ?>
                </span>
                <?php endforeach; ?>
            </div>
        ...
        <div class="comment-section">
            <div class="comment-label"><svg fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"/></svg> Comentário (opcional)</div>
            <textarea class="comment-input" id="comment" placeholder="Conte mais sobre sua experiência..."></textarea>
        </div>
    </main>

    <div class="bottom-actions">
        <button class="btn btn-skip" onclick="skip()">Pular</button>
        <button class="btn btn-submit" onclick="submit()">Enviar Avaliação</button>
    </div>
    ...
    function setRating(value) {
        ...
        // Show/hide negative tags based on rating
        document.getElementById('positive-tags').style.display = value >= 4 ? 'block' : 'none';
        document.getElementById('negative-tags').style.display = value < 4 ? 'block' : 'none';
    ...
    function submit() {
        ...
        alert('<svg fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/></svg> Avaliação enviada!\n\nObrigado pelo feedback.');
