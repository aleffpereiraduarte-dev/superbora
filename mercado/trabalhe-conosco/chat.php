...
$messages = [
    ['from' => 'client', 'text' => 'Oi! Pode pegar o leite desnatado se não tiver integral?', 'time' => '14:32'],
    ['from' => 'worker', 'text' => 'Claro! Vou verificar aqui', 'time' => '14:33'],
    ['from' => 'worker', 'text' => 'Só tem desnatado mesmo, pode ser?', 'time' => '14:35'],
    ['from' => 'client', 'text' => 'Pode sim! Obrigada 😊', 'time' => '14:35'],
];
...
function send(t){t=t||inp.value.trim();if(!t)return;add(t,'worker');inp.value='';btn.disabled=1;setTimeout(()=>add('Ok! 👍','client'),2000)}
...
function sendImg(i){if(i.files[0])add('📷 Foto enviada','worker')}
