...
$pedido = [
    ...
    'bairro' => 'Jardins',
    'referencia' => 'Próximo ao Shopping Iguatemi',
...
<body>
    ...
    <main class="main">
        ...
        <div class="status-card">
            ...
            <div class="status-text">
                ...
                <p><?= $pedido['distancia'] ?> km • <?= $pedido['itens_qtd'] ?> itens</p>
            </div>
        </div>
        ...
        <div class="info-card">
            ...
            <div class="info-address">
                ...
                <div class="address-ref">💡 <?= $pedido['referencia'] ?></div>
            </div>
        ...
        <div class="code-card">
            ...
            <div class="code-hint">Peça este código ao cliente para confirmar</div>
        </div>
    ...
    <script>
    function openMaps() {
        const address = '<?= urlencode($pedido['endereco'] . ', ' . $pedido['bairro'] . ', São Paulo') ?>';
    ...
    function finishDelivery() {
        const code = prompt('Digite o código de entrega que o cliente informou:');
        if (code && code.toUpperCase() === '<?= $pedido['codigo_entrega'] ?>') {
            if ('vibrate' in navigator) navigator.vibrate([100, 50, 200]);
            alert('🎉 Entrega confirmada!\n\nVocê ganhou R$ <?= number_format($pedido['ganho'], 2, ',', '.') ?>');
            window.location.href = 'app.php';
        } else if (code) {
            alert('<svg fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/></svg> Código incorreto. Tente novamente.');
        }
    }
    </script>
