...
$desafios = [
    ['id' => 1, 'titulo' => 'Complete 5 pedidos hoje', 'desc' => 'Finalize 5 entregas em um único dia', 'progresso' => 3, 'total' => 5, 'bonus' => 25, 'icon' => '<svg fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/></svg>', 'cor' => '#00D26A'],
    ['id' => 2, 'titulo' => 'Ganhe R$200 na semana', 'desc' => 'Acumule R$200 em ganhos esta semana', 'progresso' => 145, 'total' => 200, 'bonus' => 30, 'icon' => '<svg fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>', 'cor' => '#F59E0B'],
    ['id' => 3, 'titulo' => 'Avaliação 5 estrelas', 'desc' => 'Receba 3 avaliações de 5 estrelas seguidas', 'progresso' => 2, 'total' => 3, 'bonus' => 15, 'icon' => '<svg fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"/></svg>', 'cor' => '#8B5CF6'],
    ['id' => 4, 'titulo' => 'Madrugador', 'desc' => 'Complete um pedido antes das 8h', 'progresso' => 0, 'total' => 1, 'bonus' => 10, 'icon' => '🌅', 'cor' => '#EC4899'],
    ['id' => 5, 'titulo' => 'Sequência de 7 dias', 'desc' => 'Trabalhe 7 dias consecutivos', 'progresso' => 5, 'total' => 7, 'bonus' => 50, 'icon' => '<svg fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 18.657A8 8 0 016.343 7.343S7 9 9 10c0-2 .5-5 2.986-7C14 5 16.09 5.777 17.656 7.343A7.975 7.975 0 0120 13a7.975 7.975 0 01-2.343 5.657z"/></svg>', 'cor' => '#EF4444'],
];

$conquistas = [
    ['nome' => 'Primeira Entrega', 'icon' => '🎉', 'data' => 'Mar 2024', 'unlocked' => true],
    ['nome' => '100 Pedidos', 'icon' => '💯', 'data' => 'Abr 2024', 'unlocked' => true],
    ['nome' => 'Avaliação Perfeita', 'icon' => '<svg fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"/></svg>', 'data' => 'Mai 2024', 'unlocked' => true],
    ['nome' => 'Velocista', 'icon' => '<svg fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"/></svg>', 'data' => null, 'unlocked' => false],
    ['nome' => 'Rei das Gorjetas', 'icon' => '👑', 'data' => null, 'unlocked' => false],
    ['nome' => 'Maratonista', 'icon' => '🏃', 'data' => null, 'unlocked' => false],
];
?>
<!DOCTYPE html>
<html lang="pt-BR">
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .main { padding: 20px; padding-bottom: calc(40px + var(--safe-bottom)); }
        ...
        .achievement-card.unlocked {
            ...
            background: linear-gradient(145deg, rgba(0,210,106,0.08), var(--card));
        }
...
<body>
    <header class="header">
        <div class="header-top">
            <button class="back-btn" onclick="location.href='app.php'">←</button>
            <h1><svg fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg> Desafios</h1>
        </div>
        <p>Complete desafios e ganhe bônus extras</p>
    </header>

    <main class="main">
        <h2 class="section-title"><svg fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 18.657A8 8 0 016.343 7.343S7 9 9 10c0-2 .5-5 2.986-7C14 5 16.09 5.777 17.656 7.343A7.975 7.975 0 0120 13a7.975 7.975 0 01-2.343 5.657z"/></svg> Desafios Ativos</h2>
        
        <?php foreach ($desafios as $d): 
            $percent = min(100, ($d['progresso'] / $d['total']) * 100);
        ?>
        <div class="challenge-card">
            <div class="challenge-icon" style="background: <?= $d['cor'] ?>22;">
                <?= $d['icon'] ?>
            </div>
            <div class="challenge-content">
                ...
                <div class="challenge-progress">
                    <div class="progress-bar">
                        <div class="progress-fill" style="width: <?= $percent ?>%; background: <?= $d['cor'] ?>;"></div>
                    </div>
                    <span class="progress-text"><?= $d['progresso'] ?>/<?= $d['total'] ?></span>
                </div>
            </div>
            <div class="challenge-reward">
                <div class="reward-value">+R$<?= $d['bonus'] ?></div>
                <div class="reward-label">Bônus</div>
            </div>
        </div>
        <?php endforeach; ?>

        <section class="achievements-section">
            <h2 class="section-title"><svg fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z"/></svg> Conquistas</h2>
            <div class="achievements-grid">
                <?php foreach ($conquistas as $c): ?>
                <div class="achievement-card <?= $c['unlocked'] ? 'unlocked' : 'locked' ?>">
                    <div class="achievement-icon"><?= $c['icon'] ?></div>
                    <div class="achievement-name"><?= $c['nome'] ?></div>
                    <div class="achievement-date"><?= $c['unlocked'] ? $c['data'] : 'Bloqueado' ?></div>
                </div>
                <?php endforeach; ?>
            </div>
        </section>
