...
$stmt = $pdo->query("SELECT * FROM om_badges WHERE status = '1' ORDER BY category, requirement_value");
$badges = $stmt->fetchAll();
$stmt = $pdo->prepare("SELECT * FROM om_customer_badges WHERE customer_id = ?");
$stmt->execute([$customer_id]);
$my_badges = [];
foreach ($stmt->fetchAll() as $b) $my_badges[$b["badge_id"]] = $b;
$total = count($badges);
